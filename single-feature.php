            ...
            <div class="container">
                ...
                <div class="row align-items-center">
					<div class="col-lg-6 features-details">
						<div class="features-details-desc">
                            <p><?php echo esc_html( get_post_meta(get_the_ID(), 'startnext_feature_faq_content', true), 'startnext')?></p>
                            <?php
					...
					<div class="col-lg-6 features-details-image">
						<img src="<?php echo esc_url( get_post_meta(get_the_ID(), 'startnext_feature_faq_image', true), 'startnext')?>" class="wow fadeInUp" alt="image">
					</div>
                </div>
                <?php endwhile; ?>
            </div>
